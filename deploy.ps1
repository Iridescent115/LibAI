...
if ($LASTEXITCODE -eq 0) {
    ...
    Write-Host ""
    Write-Host "步骤 2: 复制 Worker URL" -ForegroundColor Yellow
    ...
    Write-Host ""
    Write-Host "步骤 3: 更新前端配置" -ForegroundColor Yellow
    ...
    Write-Host ""
    Write-Host "步骤 5: 部署到 Cloudflare Pages" -ForegroundColor Yellow
    Write-Host "  访问: https://dash.cloudflare.com/" -ForegroundColor White
